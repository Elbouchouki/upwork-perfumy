        ...
        <div className="flex flex-wrap ">
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="relative lg:max-w-md">
              <Image src="https://www.fragrancex.com/blog/wp-content/uploads/2022/01/best-french-perfumes-all-time-1024x415.png" alt="aboutimage"
              ...
              <div
                ...
                <p className="text-lg font-semibold md:w-72">
                  ...
                  </svg> Successfully Providing high quality perfumes since 2021
                </p>
              </div>
            </div>
          </div>
